...
\section{Application Working (on Cooja)}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.675\textwidth]{img/Screenshot_1.png}
	\caption{Starting setup.sh}
...
\begin{figure}[H]
	...
	\caption{Cooja Example with 2 Printers and 2 Sensors}
...
\begin{figure}[H]
	...
	\caption{Start Cooja, Mosquitto, Server and User App}
...
\begin{figure}[H]
	...
	\caption{Printer 1 Online, Printer 2 Online, and Printer 3 Offline}
...
\begin{figure}[H]
	...
	\caption{Printer 1 Printing, Printer 2 Online, and Printer 3 Offline}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.675\textwidth]{img/Screenshot_12.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.675\textwidth]{img/Screenshot_13.png}
	\caption{Successful Print}
	\label{fig:Screenshot-13}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.675\textwidth]{img/Screenshot_14.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{img/Screenshot_15.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{img/Screenshot_16.png}
